...
# Set the environment variable to your project's settings file
...
def populate():
    ...
    # Lists of dictionaries containing the pages for each category
    python_pages = [
    ...
    # Print out the categories and pages
